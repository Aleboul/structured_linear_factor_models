...
def save_results(A_bar, A_hat, params):
    ...
    os.makedirs(f"../data/results/operator{params['operator']}/noise{params['noise']}/results_n{params['n']}/d{params['d']}/K{params['K']}/s{params['s']}_eta{params['eta']}_alpha{params['alpha']}", exist_ok=True)

    # Construct filenames based on parameters
    filename_A_bar = f"../data/results/operator{params['operator']}/noise{params['noise']}/results_n{params['n']}/d{params['d']}/K{params['K']}/s{params['s']}_eta{params['eta']}_alpha{params['alpha']}/A_bar_niter{params['niter']}.csv"
    filename_A_hat = f"../data/results/operator{params['operator']}/noise{params['noise']}/results_n{params['n']}/d{params['d']}/K{params['K']}/s{params['s']}_eta{params['eta']}_alpha{params['alpha']}/A_hat_niter{params['niter']}.csv"
